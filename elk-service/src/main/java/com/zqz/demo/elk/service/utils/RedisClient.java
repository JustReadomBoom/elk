package com.zqz.demo.elk.service.utils;
...
public class RedisClient {
     ...
     * @param keyValues
     */
    public void expire(String keyFormat, Integer num, TimeUnit unit, String... keyValues) {
        String key = format(keyFormat, keyValues);
        //TimeUnit.SECONDS
     ...
     * @param unit
     */
    public void putHash(String hashKey, String keyStr, Object obj, Integer num, TimeUnit unit) {
        redisTemplate.opsForHash().put(hashKey, keyStr, obj);
        if (unit == null || num == null) {
            redisTemplate.expire(hashKey, num, unit);//TimeUnit.SECONDS
        }
    }
     ...
     * @return
     */
    public Object getHashValue(String hashKey, String keyStr) {
        return redisTemplate.opsForHash().get(hashKey, keyStr);
    }

    /**
     * 判断 map 是否存在 键为 keyStr
     *
     * @param hashKey
     * @param keyStr
     * @return
     */
    public boolean isExistHashField(String hashKey, String keyStr) {
        return redisTemplate.opsForHash().hasKey(hashKey, keyStr);
    }
     ...
     * @return
     */
    public Map<Object, Object> getAllHashValue(String hashKey) {
